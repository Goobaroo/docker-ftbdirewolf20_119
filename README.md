# [FTB Presents Direwolf20 1.19](https://feed-the-beast.com/modpack/101-ftb_presents_direwolf20_1_19) By FTB
...
The docker on first run will download the same version as tagged of `FTB Presents Direwolf20 1.19` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "FTB Presents Direwolf20 1.19 Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-ftbdirewolf20_119

Docker: https://hub.docker.com/repository/docker/goobaroo/ftbdirewolf20_119